            ...
            <div class="mx-2 mt-4 shadow bg-white sm:w-full max-w-2xl rounded">
                <div class="p-3 flex justify-between items-center">
                    ...
                    <form action="" class="w-44 md:w-72">
                        <div class="relative">
                            <input wire:model="search" class="px-3 py-2 w-full form-input text-gray-500 border-2 border-green-500 focus:outline-none focus:ring-2 focus:ring-green-300 rounded"
